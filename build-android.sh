...
# This script builds all android target platforms of OpenFst and installs the library in
# folder $PREFIX.
#
...
do
  ...
  ./configure --host "$TARGET" --prefix="$INST_DIR" --enable-far --enable-grm --enable-fsts --disable-shared --enable-static CFLAGS="-fPIC" CXXFLAGS="-fPIC"
